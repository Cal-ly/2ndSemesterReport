...
I \Cref{chapter:conclusion} forefindes afsnittet \Cref{sec:conclusion_summary}, der opsummerer analyse og delkonklusioner vedrørende selve \emph{SCRUM}-processen i projektet.
